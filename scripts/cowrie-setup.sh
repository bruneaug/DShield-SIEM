...
$curlcmd -s -H 'Content-Type: application/x-ndjson' -XPUT https://es01:9200/_ilm/policy/cowrie.ttylog --data-binary @cowrie.ttylog-policy.json; echo
$curlcmd -s -H 'Content-Type: application/x-ndjson' -XPUT https://es01:9200/_index_template/cowrie.ttylog --data-binary @cowrie.ttylog-index.json; echo
